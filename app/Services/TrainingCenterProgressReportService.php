...
//        $date=$data['reporting_month'];
        ...
        $rules = [
            ...
            'number_of_trainers' => 'sometimes|required|int|min:1',
            'number_of_labs_or_training_rooms' => 'sometimes|required|int|min:1',
            'number_of_computers_or_training_equipments' => 'sometimes|required|int|min:1',

            'admitted_trainee_men' => 'sometimes|required|int|min:1',
            'admitted_trainee_women' => 'sometimes|required|int|min:1',
            'admitted_trainee_disable' => 'sometimes|required|int|min:1',
            'admitted_trainee_qawmi' => 'sometimes|required|int|min:1',
            'admitted_trainee_transgender' => 'sometimes|required|int|min:1',
            'admitted_trainee_others' => 'sometimes|required|int|min:1',

            'technical_board_registered_trainee_men' => 'sometimes|required|int|min:1',
            'technical_board_registered_trainee_women' => 'sometimes|required|int|min:1',
            'technical_board_registered_trainee_disabled' => 'sometimes|required|int|min:1',
            'technical_board_registered_trainee_qawmi' => 'sometimes|required|int|min:1',
            'technical_board_registered_trainee_transgender' => 'sometimes|required|int|min:1',
            'technical_board_registered_trainee_others' => 'sometimes|required|int|min:1',


            'latest_test_attended_trainee_men' => 'sometimes|required|int|min:1',
            'latest_test_attended_trainee_women' => 'sometimes|required|int|min:1',
            'latest_test_attended_trainee_disabled' => 'sometimes|required|int|min:1',
            'latest_test_attended_trainee_qawmi' => 'sometimes|required|int|min:1',
            'latest_test_attended_trainee_transgender' => 'sometimes|required|int|min:1',
            'latest_test_attended_trainee_others' => 'sometimes|required|int|min:1',

            'latest_test_passed_trainee_men' => 'sometimes|required|int|min:1',
            'latest_test_passed_trainee_women' => 'sometimes|required|int|min:1',
            'latest_test_passed_trainee_disabled' => 'sometimes|required|int|min:1',
            'latest_test_passed_trainee_qawmi' => 'sometimes|required|int|min:1',
            'latest_test_passed_trainee_transgender' => 'sometimes|required|int|min:1',
            'latest_test_passed_trainee_others' => 'sometimes|required|int|min:1',
