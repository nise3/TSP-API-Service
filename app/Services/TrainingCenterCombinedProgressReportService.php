...
class TrainingCenterCombinedProgressReportService
{
    ...
    public function validator(Request $request): \Illuminate\Contracts\Validation\Validator
    {
        ...
        $rules = [
            ...
            'subscriptions_collected_so_far' => 'nullable|int|min:0',
            'subscriptions_collected_in_current_month_organization' => 'nullable|int|min:0',
            'subscriptions_collected_in_current_month_member' => 'nullable|int|min:0',
            'subscriptions_collected_in_current_month_total' => 'nullable|int|min:0',
            'grants_received_in_current_month_source' => 'nullable|string',
            'grants_received_in_current_month_amount' => 'nullable|int|min:0',
            'grants_received_in_current_month_total' => 'nullable|int|min:0',
            'gross_income' => 'nullable|int|min:0',

            'income_in_skills_development_sector_trades' => 'nullable|int|min:0',
            'income_in_skills_development_sector_money' => 'nullable|int|min:0',
            'expenditure_in_skill_development_training' => 'nullable|int|min:0',
            'expenditure_in_other_sectors' => 'nullable|int|min:0',
            'expenditure_total' => 'nullable|int|min:0',
            'total_income_in_the_training_sector' => 'nullable|int|min:0',
            'bank_status_and_account_number' => 'nullable|string',
            'bank_interest' => 'nullable|int|min:0',
