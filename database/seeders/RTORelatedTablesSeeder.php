...
class RTORelatedTablesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('rpl_occupations')->insert([
            ...
            array('id' => '3','rpl_sector_id' => '1','title' => 'Plasterer','title_en' => 'Plasterer','translations' => '{"39": {"title": "Cameroon Plusterer"}, "99": {"title": "Honduras Plusterer"}}','created_at' => '2022-03-02 22:15:24','updated_at' => '2022-03-02 22:15:24','deleted_at' => NULL),
