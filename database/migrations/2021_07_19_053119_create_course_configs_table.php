...
class CreateCourseConfigsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('course_configs', function (Blueprint $table) {
            ...
            $table->unsignedInteger('branch_id')->default(0)->index('publish_courses_fk_branch_id');
            $table->unsignedInteger('training_center_id')->default(0)->index('publish_courses_fk_training_center_id');
            $table->unsignedInteger('programme_id')->default(0)->index('publish_courses_fk_programme_id');
